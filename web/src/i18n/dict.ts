...
const pl = {
  ...
  'patchLabel.structure': 'Struktura ujęć z pomysłu.',
  'patchLabel.structureSkipped': 'Struktura ujęć z pomysłu. Pominięto kwestie bez pasującego mówcy: {notes}.',
  'patchLabel.audioSoundscape': 'Podpowiedź pejzażu dźwiękowego.',
  'patchLabel.audioMusic': 'Podpowiedź muzyki spoza kadru.',
  'patchLabel.redactStyle': 'Redakcja stylu wizualnego z polskiego na angielski.',
  'patchLabel.redactSoundscape': 'Redakcja pejzażu dźwiękowego z polskiego na angielski.',
  'patchLabel.redactMusic': 'Redakcja muzyki spoza kadru z polskiego na angielski.',
  'patchLabel.redactSpeakerFull': 'Redakcja pełnego opisu mówcy z polskiego na angielski.',
  'patchLabel.redactSpeakerShort': 'Redakcja krótkiego opisu mówcy z polskiego na angielski.',
  'patchLabel.redactShotText': 'Redakcja treści ujęcia z polskiego na angielski.',
  'patchLabel.chatField': 'Zmiana pola z rozmowy z modelem.',
  'patchLabel.translateLabelDefinition': 'Redakcja definicji etykiety z polskiego na angielski.',
  'patchLabel.translateLabelRole': 'Redakcja roli etykiety z polskiego na angielski.',
  'patchLabel.translateRefSummary': 'Redakcja podsumowania referencji z polskiego na angielski.',
  'patchLabel.translateRetentionNote': 'Redakcja notatki retencji z polskiego na angielski.',
...
const en: Record<TKey, string> = {
  ...
  'patchLabel.structure': 'Shot structure from the idea.',
  'patchLabel.structureSkipped': 'Shot structure from the idea. Skipped lines with no matching speaker: {notes}.',
  'patchLabel.audioSoundscape': 'Suggested overall soundscape.',
  'patchLabel.audioMusic': 'Suggested non-diegetic music.',
  'patchLabel.redactStyle': 'Visual style redacted from Polish into English.',
  'patchLabel.redactSoundscape': 'Overall soundscape redacted from Polish into English.',
  'patchLabel.redactMusic': 'Non-diegetic music redacted from Polish into English.',
  'patchLabel.redactSpeakerFull': 'Speaker full descriptor redacted from Polish into English.',
  'patchLabel.redactSpeakerShort': 'Speaker short descriptor redacted from Polish into English.',
  'patchLabel.redactShotText': 'Shot text redacted from Polish into English.',
  'patchLabel.chatField': 'Field change from the conversation with the model.',
  'patchLabel.translateLabelDefinition': 'Label definition redacted from Polish into English.',
  'patchLabel.translateLabelRole': 'Label role redacted from Polish into English.',
  'patchLabel.translateRefSummary': 'Reference summary redacted from Polish into English.',
  'patchLabel.translateRetentionNote': 'Retention note redacted from Polish into English.',
